...
import com.example.greenplant.viewModel.SubmitBugViewModel
...
class SendApplicationBugActivity : BaseViewModelActivity<ActivitySendApplicationBugBinding>() {
    ...
    private val submitBugViewModel by lazy {
        ViewModelProvider(this)[SubmitBugViewModel::class.java]
    }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        submitBugViewModel.submitBugResponseLiveData.observe(this, Observer {
    ...
    override fun initListener() {
        ...
        binding.commit.setOnClickListener {
            if (nowSelect == 10){
                ...
                submitBugViewModel.setBug(selectList[nowSelect], binding.edit.text.toString())
            }
        }
    }
